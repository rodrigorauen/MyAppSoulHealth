    ...
    return(
        <View style={styles.viewContent}>
               ...
               <Image
                ...
                />
                <Infos titulo='Hidratação' autor='Autor: Rodrigo Rauen Jr'conteudo='Para se ter uma idéia da importância da água para onosso organismo, basta uma informação: a água é a responsávelpor cerca de
                    ...
                    Todos os alimentos contêm água, uns mais, outros menos. As melhores fontes de água são: a própria água, que deve ser tratada
                    adequadamente; os alimentos líquidos, como leite, sucos e bebidas, e os alimentos sólidos como verduras, frutas e carnes.'/>
